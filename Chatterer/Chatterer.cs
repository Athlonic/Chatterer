...
namespace Chatterer
{
    ...
    public partial class chatterer : MonoBehaviour
    {
            ...
            if (show_advanced_options)
            {
                ...
                if (show_chatter_sets)
                {
                    ...
                    for (i = 0; i < chatter_array.Count; i++)
                    {
                        ...
                        if (chatter_array[i].capsuleR.Count > 0) _content.text = _content.text + " (Machine set in)";
        ...
        private void initialize_new_exchange()
        {
            ...
            current_capsuleR_clip = rand.Next(0, current_capsuleR_chatter.Count); // select a new capsuleF clip to play
        ...
        private void add_default_audiosets()
        {
            ...
            chatter_array.Add(new ChatterAudioList());
            chatter_array[4].directory = "machines";
            chatter_array[4].is_active = true;
